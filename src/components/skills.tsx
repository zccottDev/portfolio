...
export const Skills: React.FC = () => {
  const frontendSkills: Skill[] = [
    ...
    { name: "Python", icon: "logos:python", color: "#3776AB", level: 80 },
    ...
    { name: "Gen AI", icon: "mdi:robot", color: "#00ADD8", level: 80 },
  ];
  ...
  const toolsSkills: Skill[] = [
    ...
    { name: "Temporal.io", icon: "mdi:workflow", color: "#000000", level: 70 },
  ];
  ...
  return (
    <section id="skills" className="py-16 md:py-24 bg-content2/50">
